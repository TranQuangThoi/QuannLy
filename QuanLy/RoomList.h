...
void RoomList::UpdateState(string id, int k)
{
	RoomNode* temp = head;
	while (temp != nullptr)
	{
...
bool RoomList::IsFullRoom(string id)
{
...
bool RoomList::IsEmptyRoom(string id)
{
...
bool RoomList::IsEmptyRoom(char type)
{
	RoomNode* temp = this->head;
	while (temp != nullptr)
	{
...
Room RoomList::GetFirstEmptyRoom(char type)
{
	RoomNode* temp = this->head;
	while (temp != nullptr)
	{
...
void RoomList::PrintEmptyRoomList()//true
{
	RoomNode* temp = this->head;
...
bool RoomList::IsExistRoom(string id)//true
{
	RoomNode* temp = this->head;
	while (temp != nullptr)
	{
...
void RoomList::AddHead(Room data)
{
...
void RoomList::DetroyRoomList()//true
{
	RoomNode* temp = this->head;
...
bool RoomList::IsNoMoreEmptyRoom()
{
	RoomNode* temp = this->head;
	while (temp != nullptr)
	{
...
void RoomList::UpdateMaxRoom()//true khi xay them phong
{
	int n;
NHAPN:
	try
...
Room RoomList::fInputRooom(ifstream& filein, bool k)
{
	Room room;
	if (k)
	{
...
void RoomList::fOutputRooms()// true
{
	ofstream fileout;
	fileout.open("DANHSACHPHONG.TXT", ios::out);
	RoomNode* temp = head;
...
void RoomList::fInputRooms()
{
	ifstream filein;
	Room room;
	bool k = false;
	filein.open("DANHSACHPHONG.TXT", ios::in);
	while (!filein.eof())
	{
